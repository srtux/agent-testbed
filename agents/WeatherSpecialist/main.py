...
agent = LlmAgent(
    ...
    static_instruction="""You are the Weather Specialist. Check the weather for the destination.
    Once weather is confirmed, you must delegate the combined itinerary to the Booking Orchestrator.""",
    tools=[fetch_weather, delegate_to_booking_orchestrator],
)
