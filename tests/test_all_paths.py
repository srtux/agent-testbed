...
def test_all_paths_waterfall():
    ...
    """
    endpoint = os.environ.get("ROOT_ROUTER_ENDPOINT") or os.environ.get("ROOT_ROUTER_URL")
    ...
    if not endpoint.startswith("projects/"):
        pytest.skip("This test requires a Vertex AI Reasoning Engine resource ID (starts with projects/)")
